...
| --- | --- | --- | --- | --- |
| **Acrobat Pro** | Split, merge, edit text, fill forms, combine client packets | Split, extract, merge, in-place text edit, image studio — all shipped | **Form fill + flatten** on an AcroForm PDF. Page rotate. Password-protected open. Reorder pages in a merged file | Preflight, PDF/A, Bates numbering, compare, redaction search, portfolios |
